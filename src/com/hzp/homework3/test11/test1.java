package com.hzp.homework3.test11;
 ...
 * @BelongsPackage: com.hzp.homework3.test11
 * @Author: ASUS
 * @CreateTime: 2023-11-01  21:19
 * @Description: TODO
 * @Version: 1.0
 */
public class test1 {
    ...
    public static void main(String[] args)
    {
        ...
        for (j=0;j<i;j++){
            if(list.get(j) == 0.0) System.out.println("零元整"); //处理特殊情况
            else System.out.println(test1.toString(list.get(j)));
        }
        get.close();
